...
# Replace MetadataSidebar class and update_metadata method completely
sidebar_pattern = r'class MetadataSidebar.*?def display_fec_result\(self, vit_res, rs_res, deint_res\):.*?self\.final_bitstream_text\.setText\(hex_str\)'
